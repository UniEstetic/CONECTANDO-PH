...
import ComunicadoCard from '@/app/components/ComunicadoCard'
import EncuestaModal from '@/app/components/EncuestaModal'
import DetalleModal from '@/app/components/DetalleModal'
